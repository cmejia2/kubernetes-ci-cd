...
docker build -t mycluster.icp:8443/puzzle:$TAG -f applications/puzzle/Dockerfile applications/puzzle
...
#Push the images
docker push mycluster.icp:8443/puzzle:$TAG

#Stop the registry proxy
# docker stop socat-registry

# Create the deployment and service for the puzzle server aka puzzle
sed 's#mycluster.icp:8443/puzzle:latest#mycluster.icp:8443/puzzle:'$TAG'#' applications/puzzle/k8s/deployment.yaml | kubectl apply -f -
