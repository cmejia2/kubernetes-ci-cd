...
# docker build -t mycluster.icp:8443/kubescale:$TAG -f 

# # echo "building set image"

# cd set; docker build -t mycluster.icp:8443/set:$TAG -f set/Dockerfile .
...
# docker push mycluster.icp:8443/kubescale:latest
# docker push mycluster.icp:8443/set:latest
